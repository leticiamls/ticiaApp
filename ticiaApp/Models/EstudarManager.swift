...
class EstudarManager {
    let estudosLista: [Estudo] = [
        ...
        Estudo(tituloEstudo: "Erros gramaticais", descricaoEstudo: "A presença de erros de grosseiros de portugues, a falta de coesão e a pontuação excessiva são sinais que exigem atenção.", exemploMentira: "O GOVERMO VAI CONFICAR SUA POUPANÇA AMANA!!!!! COMO EVITAR VEJA...", exemploVerdade: "Banco Central informa novas regras para o rendimento da poupança"),
        Estudo(tituloEstudo: "URL’s Falsas ou erradas", descricaoEstudo: "Criação de endereços web que **imitam** portais de notícias famosos, alterando uma letra ou usando extensões incomuns (como .net.br, .co em vez de .pt ou .com.br ). ", exemploMentira: "hps://a.cnnbrazil.con.net.pt.url", exemploVerdade: "https://www.cnnbrasil.com.br")]
